...
An executable version on kaggle can be found [HERE](https://www.kaggle.com/danielhain/sds-2018-m1-7-unsupervised-ml)
...
library(mice)
data.mice <- mice(data = data[,vars], m = 1, maxit = 50, seed = 1337) 
